...
class HuggingFaceClient {
  ...
  /**
   * Gestisce gli errori HTTP provenienti dalle API Hugging Face.
   *
  ...
  async _handleHttpError(response) {
    ...
    try {
      ...
      console.error("HuggingFaceClient._handleHttpError:", e);
  ...
  /**
   * Gestisce gli errori di rete o i timeout per Hugging Face.
   *
